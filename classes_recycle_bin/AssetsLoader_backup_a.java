...
public class AssetsLoader_backup_a {
    ...
    public final Multiple multiple = null;
    public final Single single = null;
    ...
    /// @return The temporary directory as {@link Path}, where the packs should be located.
    public Path getTempPacksDir() {
        return GAME_DIR.resolve(tempDirectory);
    }


    public static class Single {
        private AssetsLoader_backup_a assetsLoader;

        protected Single(AssetsLoader_backup_a assetsLoader) {
    ...
    public static class Multiple {
        ...
        private final String tempDirectory;
        private final List<String> modJarFiles;
        private final List<NamespaceCouple> namespacesCouples;
        private final String iconFileName;
        private final String resourcePackFolderName;
        private final Component packTitle;
        private final Component packDescription;



        protected Multiple(String tempDirectory, List<String> modJarFiles, List<NamespaceCouple> namespacesCouples, @Nullable String iconFileName,
                           String resourcePackFolderName, Component packTitle, Component packDescription, boolean deletePack, boolean resourcePackCanBeDisabled) {
            this.tempDirectory = tempDirectory;
            this.modJarFiles = modJarFiles;
    ...
    public AssetsLoader_backup_a(String tempDirectory, List<String> modJarFiles, List<NamespaceCouple> namespacesCouples, @Nullable String iconFileName,
                                 String resourcePackFolderName, Component packTitle, Component packDescription, boolean deletePack, boolean resourcePackCanBeDisabled) {
        logModInfo();
        this.tempDirectory = tempDirectory;
        this.modJarFiles = modJarFiles;
        ...
        this.resourcePackFolderName = resourcePackFolderName;
        this.packTitle = packTitle;
        this.packDescription = packDescription;
    }

    public void loadMultipleResourcePacks*/
    ...
    /**
     * Does the same as {@link AssetsLoader_backup_a#createPack(String, Component, Component, Path, boolean)}.
     * @param internalPackId The game internal id of the pack. You will never see this, but remember to avoid creating duplicates.
     * @param packTitle The in-game title of the resourcepack.
     * @param packDescription The in-game description of the resourcepack.
     * @param packPath The path where to find the pack. Needs to be the folder containing the {@code assets} folder.
     ...
     * <br><b>NOTE:</b> it doesn't copy the icon file, use {@link AssetsLoader_backup_a#copyJarIcon(Path, String, Path, String)} for that.
    ...
    /**
     * @deprecated - Unsafe for file walks, paths resolving, etc...
     * <br><br>
